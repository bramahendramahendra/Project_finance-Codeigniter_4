...
<div class="modal fade" id="add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('jenis_status/store') ?>
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Jenis Status</label>
                    <input type="text" name="jenis_status" class="form-control" placeholder="Jenis Status" required>
                </div>
                <div class="form-group">
    ...
    <div class="modal fade" id="edit-data<?= $value['id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('jenis_status/update/'.$value['id']) ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">Jenis Status</label>
    ...
    <div class="modal fade" id="delete-data<?= $value['id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('jenis_status/delete/'.$value['id']) ?>" class="btn btn-danger btn-flat">Delete</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
