                ...
                <table id="table-datatables" class="table table-bordered table-striped table-datatables">
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $value) { ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $value['jenis_status'] ?></td>
                                <td><?= $value['code_status'] ?></td>
                                <td><?= $value['status'] ?></td>
...
<div class="modal fade" id="add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('status/store') ?>
            <div class="modal-body">
                <div class="form-group">
                    <label for="jenis_status">Jenis Status</label>
                    <select name="jenis_status" class="form-control select2" id="create_jenis_status" style="width: 100%;" required>
                        <?php foreach ($optionsJenisStatus as $jenisStatus): ?>
                            <option value="<?= esc($jenisStatus['id']); ?>"><?= esc($jenisStatus['jenis_status']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                    <label for="">Code Status</label>
                    <input type="text" name="code_status" class="form-control" placeholder="Code Status" id="create_code_status" onchange="checkCodeStatus()" required>
                </div>
                <div class="form-group">
                    <label for="">Status</label>
                    <input type="text" name="status" class="form-control" placeholder="Status" id="create_status" required>
                </div>
                <div class="form-group">
    ...
    <div class="modal fade" id="delete-data<?= $value['id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Yakin Hapus  <b><?= $value['jenis_status'] ?></b>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('status/delete/'.$value['id']) ?>" class="btn btn-danger btn-flat">Delete</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
