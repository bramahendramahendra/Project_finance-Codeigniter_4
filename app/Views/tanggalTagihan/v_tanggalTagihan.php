...
<div class="modal fade" id="add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('tanggal_tagihan/store') ?>
    ...
    <div class="modal fade" id="edit-data<?= $value['id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('tanggal_tagihan/update/'.$value['id']) ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="tanggal">Tanggal</label>
                        <input type="text" name="tanggal" value="<?= $value['tanggal'] ?>" class="form-control" placeholder="Tanggal" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
